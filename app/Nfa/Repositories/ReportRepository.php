...
class ReportRepository implements ReportRepositoryInterface
{
    public function getPublicDateByYear($year)
    {
        ...
        $reportPublicDate = ReportPublicDate::where('year', $year)->where('date_type', 'reports')->first();
    ...
    public function getPublicDates()
    {
        ...
        $publicDates = ReportPublicDate::where('date_type', 'reports')->orderBy('year', 'DESC')->get();
    ...
    public function updatePublicDate($id, $year, $date, $expire_soon_date, $expire_date)
    {
        ...
        $publicDate = ReportPublicDate::where('date_type', 'reports')->find($id);
