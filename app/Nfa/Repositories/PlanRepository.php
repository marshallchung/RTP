...
class PlanRepository implements PlanRepositoryInterface
{
    public function getPublicDateByYear($year)
    {
        ...
        $reportPublicDate = ReportPublicDate::where('year', $year)->where('date_type', 'plan')->first();
    ...
    public function getPublicDates()
    {
        ...
        $publicDates = ReportPublicDate::where('date_type', 'plan')->orderBy('year', 'DESC')->get();
    ...
    public function updatePublicDate($id, $year, $date, $expire_soon_date, $expire_date)
    {
        ...
        $publicDate = ReportPublicDate::where('date_type', 'plan')->find($id);
