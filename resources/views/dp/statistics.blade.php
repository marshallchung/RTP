...
<div x-data="{
    ...
    <div
        ...
        <div class="flex flex-col items-center justify-center w-full pb-8 space-y-4 sm:pb-0 sm:w-72">
            ...
            <a href="../resource/map" class="underline text-mainBlue underline-offset-4">全台防災士分布圖</a>
            <span style="font-weight:bold;">防災士總人數：{{ $dpStudentStatistics['normal_total'] }} </span>
            <span style="font-weight:bold;">男性：{{ $dpStudentStatistics['normal_male_count'] }} （{{
                $dpStudentStatistics['normal_county_male_percentage']
                }}%）</span>
            <span style="font-weight:bold;">女性：{{ $dpStudentStatistics['normal_female_count'] }} （{{
                $dpStudentStatistics['normal_county_female_percentage']
                }}%）</span>
            <span class="text-rose-600">（截至 {{$endDate}}）</span>
            <div class="w-40 mx-auto overflow-hidden">
                <canvas data-te-chart="pie" data-te-labels="['男' , '女']"
                    data-te-dataset-data="[{{ $dpStudentStatistics['normal_male_count'] }}, {{ $dpStudentStatistics['normal_female_count'] }}]"
                    data-te-dataset-background-color="['rgba(129, 198, 206, 1)', 'rgba(233, 148, 160, 1)']">
                </canvas>
            </div>
            <a target="_blank" href="/dp/statistics/export"
        ...
        <div class="flex flex-col items-center justify-start w-full space-y-4 sm:flex-1">
            <div class="flex flex-row w-full px-2 space-x-2 sm:px-0">
                <a href="/dp/statistics?county_area=0"
                ...
                <a href="/dp/statistics?county_area=1"
                ...
                <a href="/dp/statistics?county_area=2"
                ...
                <a href="/dp/statistics?county_area=3"
                ...
                <a href="/dp/statistics?county_area=4"
