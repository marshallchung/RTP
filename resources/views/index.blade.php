...
<div x-data="{
    selected: 0,
    slides:{{ json_encode($homePageCarouselItems) }},
        ...
        <div class="flex flex-col items-start justify-start w-full sm:flex-1">
            ...
            <div
                ...
                <span class="text-left text-mainBlueDark">
                    {{ link_to_route('introduction.public-news.show', $item->title, $item)
                    }}
                </span>
            </div>
            @empty
                    ...
                    <td class="p-2 text-center border-r last:border-r-0">
                        <div class="flex flex-col items-start justify-start space-y-1">
                            ...
                            <div class="flex flex-row items-center justify-between w-full">
                                <span
                                    class="p-1 text-xs text-white rounded-md {{ $item->advance?'bg-amber-600':'bg-mainBlue' }}">{{
        ...
        <div
            ...
            <a href="/dp/statistics"
                ...
                <div class="flex flex-row items-center justify-center space-x-2">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <span class="text-sm text-gray-400 sm:text-lg">（截至 {{$endDate}} ）</span>
                    </div>
                </div>
                <div class="flex flex-row items-center justify-center space-x-2">
                    <span class="font-sans text-[3rem] sm:text-[6.5rem] text-mainYellow font-extrabold">
                                       {{ number_format($dpStudentStatistics['normal_total']) }}
                    </span>
            ...
            <a href="/dp/advanced-statistics"
                ...
                <div class="flex flex-row items-center justify-center space-x-2">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <span class="text-sm text-gray-400 sm:text-lg">（截至 {{ $end_year }} 年 {{
                            $end_month }} 月）</span>
                    </div>
                </div>
                <div class="flex flex-row items-center justify-center space-x-2">
                    <span class="font-sans text-[3rem] sm:text-[6.5rem] text-mainYellow font-extrabold">
                        {{ number_format($dpStudentStatistics['advanced_total']) }}
                    </span>
                    <span class="-mb-12 text-lg text-gray-400">名</span>
                </div>
            </a>
            <a href="/dc/show-unit"
                ...
                <div class="flex flex-row items-center justify-center space-x-2">
                    <span class="font-sans text-[3rem] sm:text-[6.5rem] text-mainYellow font-extrabold">
                        {{
                        number_format((array_key_exists('一星',$rankCount)?$rankCount['一星']:0)+(array_key_exists('二星',$rankCount)?$rankCount['二星']:0)+(array_key_exists('三星',$rankCount)?$rankCount['三星']:0))
                        }}
                    </span>
