...
<body>
  <div
    ...
    <div class="panel panel-primary hidden-xs">
      <div class="text-mainAdminTextGrayDark bg-gray-100 border-gray-200 border-b-2 pb-2 px-5 pt-3 relative">
      ...
      <div class="col-sm-10 col-xs-12" id="main">
        <nav class="navbar navbar-default" id="nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand py-[0.3125rem] ml-4 text-xl whitespace-nowrap clickable hide" id="to-previous">
              <i class="fa fa-arrow-left"></i>
              <span class="hidden-xs">{{ trans('laravel-filemanager::lfm.nav-back') }}</span>
            </a>
            <a class="navbar-brand py-[0.3125rem] ml-4 text-xl whitespace-nowrap visible-xs" href="#">{{
              trans('laravel-filemanager::lfm.title-panel') }}</a>
          </div>
          <div class="navbar-collapse" id="nav-buttons">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('unisharp.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post'
            ...
            <div class="flex flex-row flex-wrap text-center" id="attachment">
        ...
        <div class="modal-footer">
          ...
          <button type="button"
            ...
            id="upload-btn">{{ trans('laravel-filemanager::lfm.btn-upload')
            }}</button>
        </div>
      </div>
    </div>
