  ...
  <div class="container">
    ...
    <div class="flex flex-row flex-wrap">
      <div class="col-md-6">
        <h2>CKEditor</h2>
        <textarea name="ce"
          class="inline-block w-auto align-middle bg-white border-gray-300 rounded-md shadow-sm placeholder:text-mainTextGray focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50"></textarea>
      </div>
      <div class="col-md-6">
        <h2>TinyMCE</h2>
        <textarea name="tm"
