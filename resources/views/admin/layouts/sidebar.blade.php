<div x-data="{
    ...
    <div class="pb-6 transition-all duration-300" :class="{'w-[240px]':openMMC,'w-[56px]':!openMMC}">
        <ul class="w-full">
            @if(Auth::user()->hasPermission('admin-permissions') || Auth::user()->hasPermission('NFA-permissions') ||
            ...
            @if (Auth::user()->hasPermission('sidebar-news'))
            ...
            <li @click.away="unsetClickMenu('計畫規範與相關資料')" @mouseenter="setFloatMenu('計畫規範與相關資料')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->hasPermission('create-uploads'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                    ...
                    @endif
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.uploads.view') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
            ...
            <li @click.away="unsetClickMenu('成果資料')" @mouseenter="setFloatMenu('成果資料')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->isAbleTo('create-report-public-date'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.reports.date.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="pl-6">資料公開時間</span></a>
                    </li>
                    @endif
                    @if (Auth::user()->isAbleTo('create-reports'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.reports.submit', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                        p-[14px] space-x-2">
                            <span class="pl-6">資料上傳</span></a>
                    </li>
                    @endif
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.reports.index', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                    p-[14px] space-x-2">
                            <span class="pl-6">資料展示</span></a>
                    </li>
                    @if (Auth::user()->isAbleTo('create-report-public-date'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.reports.inquire', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                        p-[14px] space-x-2">
                            <span class="pl-6">管理與查詢功能</span></a>
                    </li>
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.reports.evaluationCommission.index', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                            p-[14px] space-x-2">
                            <span class="pl-6">管考作業</span></a>
                    </li>
                    @else
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.reports.inquireByCounty', ['year' => date('Y')]) }}?category_id=&year=2023"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                            p-[14px] space-x-2">
                            <span class="pl-6">管理與查詢功能</span></a>
                    </li>
                    @endif
                    @if (Auth::user()->hasPermission('create-report-public-date'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.reports.distribute.index') }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                                            p-[14px] space-x-2">
            ...
            @if(Auth::user()->hasPermission('create-plans') || Auth::user()->hasPermission('create-plans-for-county'))
            <li @click.away="unsetClickMenu('執行計畫書')" @mouseenter="setFloatMenu('執行計畫書')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->isAbleTo('create-plans-public-date'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.plans.date.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="pl-6">資料公開時間</span></a>
                    </li>
                    @endif
                    @if (Auth::user()->hasPermission('create-plans') ||
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('view-plans'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.plans.inquire', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                        p-[14px] space-x-2">
            ...
            <li @click.away="unsetClickMenu('期末簡報')" @mouseenter="setFloatMenu('期末簡報')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->isAbleTo('create-presentation-public-date'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.presentation.date.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="pl-6">資料公開時間</span></a>
                    </li>
                    @endif
                    ...
                    Auth::user()->hasPermission('County-permissions'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.presentation.create', [
                                        'year' => date('Y'),
                                        ]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                                        p-[14px] space-x-2">
                            <span class="pl-6">資料上傳</span></a>
                    ...
                    @if (Auth::user()->hasPermission('view-plans'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.presentation.inquire', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                                    p-[14px] space-x-2">
                            <span class="pl-6">資料展示</span>
                        </a>
                    </li>
            ...
            @if(Auth::user()->hasPermission('sidebar-samplereport'))
            <li @click.away="unsetClickMenu('優選範本')" @mouseenter="setFloatMenu('優選範本')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->isAbleTo('create-sample-report-public-date'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.sample-report.date.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="pl-6">資料公開時間</span></a>
                    </li>
                    @endif
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.sample-report.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
            ...
            @if (Auth::user()->hasPermission('create-seasonalReports') ||
            ...
            <li @click.away="unsetClickMenu('執行進度管制表')" @mouseenter="setFloatMenu('執行進度管制表')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->isAbleTo('create-seasonal-report-public-date'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.seasonal-report.date.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="pl-6">資料公開時間</span></a>
                    </li>
                    @endif
                    @if (Auth::user()->hasPermission('create-seasonalReports'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.seasonalReports.submit', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                            p-[14px] space-x-2">
                            <span class="pl-6">資料上傳{{Auth::user()->role}}</span></a>
                    </li>
                    @endif
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.seasonalReports.index', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                            p-[14px] space-x-2">
                            <span class="pl-6">資料展示</span></a>
                    </li>
                    @if (Auth::user()->hasPermission('view-all-seasonalReports'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.seasonalReports.inquire', ['year' => date('Y')]) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                            p-[14px] space-x-2">
                            <span class="pl-6">管理與查詢功能</span></a>
                    </li>
                    @elseif (Auth::user()->hasPermission('create-seasonalReports'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.seasonalReports.inquireByCounty') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="pl-6">管理與查詢功能</span></a>
                    </li>
                    @endif
            ...
            @if (Auth::user()->hasPermission('sidebar-address'))
            <li @click.away="unsetClickMenu('通訊錄')" @mouseenter="setFloatMenu('通訊錄')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if(Auth::check() && (in_array(Auth::user()->type, ['county', 'district']) ||
                    empty(Auth::user()->type)))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.address.manage') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
            ...
            <li @click.away="unsetClickMenu('民眾版')" @mouseenter="setFloatMenu('民眾版')"
                ...
                <ul class="flex-col flex mt-1.5   z-10 max-h-0 overflow-hidden"
                    ...
                    Auth::user()->hasPermission('NFA-permissions')) <li
                        ...
                        <a href="{{ route('admin.reports.submit', ['year' => 2017, 'title' => '成果網資料上傳']) }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                                p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.sign-location.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.public-news.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.home-page-carousel-image.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
            ...
            @if (Auth::user()->hasPermission('modify-static-page'))
            <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
            ...
            <li @click.away="unsetClickMenu('防災士培訓')" @mouseenter="setFloatMenu('防災士培訓')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    Auth::user()->hasPermission('DEP-permissions'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.front-introduction.edit', 1) }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dp-teachers.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('DP-students-manage') ||
                    Auth::user()->hasPermission('DP-Training-permissions'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dp-students.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('DP-courses-manage') ||
                    Auth::user()->hasPermission('DP-Training-permissions'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dp-courses.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    {{-- <!-- 2024/12/04 功能暫時下架
                    @if (Auth::user()->hasPermission('DP-course-plan-document-manage'))
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dp-courses-document.create') }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                                            p-[14px] space-x-2">
                            <span class="pl-6">防災士培訓計畫上傳</span></a>
                    </li>
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dp-courses-result.create') }}" class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white
                                        p-[14px] space-x-2">
                            <span class="pl-6">防災士培訓計畫成果上傳</span>
                        </a>
                    </li>
                    @endif
					 --> --}}

                    @if (Auth::user()->hasPermission('DP-experiences-manage'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dp-experiences.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('DP-news-manage'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dpDownload.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('DP-training-institution-manage'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dp-training-institution.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
            ...
            <li @click.away="unsetClickMenu('進階防災士培訓')" @mouseenter="setFloatMenu('進階防災士培訓')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    <li class="border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dp-advanced-students.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
            ...
            <li @click.away="unsetClickMenu('推動韌性社區')" @mouseenter="setFloatMenu('推動韌性社區')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (!Auth::user()->hasPermission('County-permissions'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.front-introduction.edit', 2) }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @endif
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dc-units.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    <!-- TODO: -->
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dc-stages.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dc-stages-list.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dc-certifications.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    {{-- <!-- 
				        <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                                <a href="{{ route('admin.dc-certifications-review.index') }}"
                                    class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                                    <span class="transition-transform duration-300"
                                        :class="{'opacity-0 transition-all duration-500':!(showSubMenu || (floatMenu && !openMMC)),' translate-x-6 opacity-100 transition-all duration-500':(showSubMenu || (floatMenu && !openMMC))}">標章申請表審查</span></a>
					    </li>
					 --> --}}
                    {{-- <!-- 2024/12/04 功能暫時下架
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
					...
					2024/12/04 功能暫時下架 --> --}}
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.dcDownload.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                                :class="{'opacity-0 transition-all duration-500':!(showSubMenu || (floatMenu && !openMMC)),' translate-x-6 opacity-100 transition-all duration-500':(showSubMenu || (floatMenu && !openMMC))}">相關資料下載(民眾版)</span></a>
                    </li>
            ...
            @endif
            @if(!Auth::user()->hasPermission('DEP-permissions') &&
            !Auth::user()->hasPermission('DP-Training-permissions'))
            <li @click.away="unsetClickMenu('操作教學說明文件')" @mouseenter="setFloatMenu('操作教學說明文件')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->hasPermission('create-guidance'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.guidance.create') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
            ...
            <li @click.away="unsetClickMenu('績效評估指標')" @mouseenter="setFloatMenu('績效評估指標')"
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->hasPermission('create-questionnaires'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                    ...
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.questionnaire.panel') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.questionnaire.statistic') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
            ...
            @if (Auth::user()->hasPermission('admin-permissions') || Auth::user()->hasPermission('NFA-permissions')) <li
                ...
                <ul class="flex-col flex mt-1.5 bg-mainMenuOpenBG z-10 max-h-0 overflow-hidden"
                    ...
                    @if (Auth::user()->hasPermission('topic-manage'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.admin.reportTerms') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('create-publicTerms'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.frontDownload.index') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @if (Auth::user()->hasPermission('create-publicTerms'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.admin.publicTerms') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('create-publicUrls'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
                        <a href="{{ route('admin.admin.countyOrder') }}"
                            class="flex flex-row items-center justify-start transition-all duration-300 text-gray-100 hover:text-white p-[14px] space-x-2">
                            <span class="transition-transform duration-300"
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('activity-log.access'))
                    <li class="transition-all duration-300 border-l-4 border-l-transparent hover:border-l-mainCyanDark">
