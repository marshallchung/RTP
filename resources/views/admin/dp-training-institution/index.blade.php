...
<div x-data="{
    ...
    getData(page){
        location.href = this.makUrl('{{ route('admin.dp-training-institution.index') }}',page);
    },
    updateActive(e){
        var This=this;
    ...
    preDragOrder: {{ $data->makeHidden('updated_at')->toJson(JSON_PRETTY_PRINT) }},
    dragstart(event) {
    ...
    editRoute:'{{ route('admin.dp-training-institution.edit', 99999999) }}',
    updateRoute:'{{ route('admin.dp-training-institution.update', 99999999) }}',
    ...
    @include('admin.dp-training-institution.partials.filter')
