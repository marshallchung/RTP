...
<div class="flex flex-col items-start justify-start w-full p-4 space-y-6" x-data="" x-init="$nextTick(() => {
            ...
            <div class="p-5 m-0 bg-white">
                ...
                <div class="flex flex-col items-center justify-center py-16">
                    <div class="flex flex-col items-center justify-center w-full">
                        ...
                        <div class="flex flex-row items-center justify-start w-full p-2 mb-4 bg-mainLight well"
                            data-id="{{ $file->id }}">
