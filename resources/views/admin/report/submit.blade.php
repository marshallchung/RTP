...
<div x-data="{
    ...
    gotoUpload(url){
        location.href = url + '&year=' + this.year;
    },
                ...
                <tbody class="text-content text-mainAdminTextGrayDark">
                    ...
                    <tr class="bg-white border-b last:border-b-0">
                            ...
                            <div x-data="{
                                ...
                                <div x-show="showCollapse" class="flex-col hidden space-y-1"
                                    ...
                                    <div class="p-0 m-0">
                                        ...
                                        ['admin.reports.delete-file-in-submit-page', $file], 'class' =>
                        ...
                        <td class="text-center align-middle">
                            <button type="button"
                                class="flex items-center justify-center w-24 h-8 text-sm text-white bg-sky-500 hover:bg-sky-400"
                                @click="gotoUpload('{{ route('admin.'. $reportType . '.create',['id'=>$item->id,'title'=>$title]) }}')">上傳檔案</button>
                        </td>
                    </tr>
                    @endforeach
                    @endforeach
