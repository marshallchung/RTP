...
'heading' => '防災士培訓-相關資料',
'header_btn' => ['新增', route('admin.dpDownload.create')],
'breadcrumbs' => ['相關資料列表']
])
...
<div x-data="{
    loading:false,
    getData(page){
        location.href = '{{ route('admin.dpDownload.index') }}?page=' + encodeURIComponent(page);
    },
    updateActive(e){
        var This=this;
    ...
    editRoute:'{{ route('admin.dpDownload.edit', 99999999) }}',
    updateRoute:'{{ route('admin.dpDownload.update', 99999999) }}',
    ...
    <table class="w-full bg-white border shadow-lg text-mainAdminTextGrayDark" @keydown.window.tab="usedKeyboard = true"
        ...
        <tbody class="text-content text-mainAdminTextGrayDark sortable" data-entityname="dp_downloads">
