...
<div x-data="{
    ...
    @include('admin.layouts.partials.genericPostForm', ['showDelete' => true,'dontShowOnlineCheckbox'=>true, 'noTitle'
    =>true])
    {!! Form::close() !!}
    {!! Form::open(['method'=>'DELETE', 'route' => ['admin.reports.distribute.delete']]) !!}
    <input type="hidden" name="id" value="{{ $data['id'] }}">
    <input type="hidden" name="title" value="{{ $data['title'] }}">
