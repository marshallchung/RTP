...
<div x-data="{
    ...
    {!! Form::open(['method' => 'POST', 'route' => 'admin.dp-advanced-students.store', 'files' => true,'class'=>'flex
    flex-row
        ...
        <div class="relative w-full mb-6 bg-white border border-gray-200 rounded-sm">
            ...
            <div class="flex flex-col w-full p-5 m-0 space-y-6 bg-white">
                ...
                <div class="flex flex-row flex-wrap text-center">
                    ...
                    <div class="flex flex-row flex-wrap text-center">
                        <label class="radio-inline">{!! Form::radio('gender', '男', null, ['required','class' =>
                            'border-gray-300
                            rounded-full bg-white text-mainCyanDark']) !!}男</label>
                        <label class="radio-inline">{!! Form::radio('gender', '女', null, ['required','class' =>
                            'border-gray-300
                ...
                <div class="flex flex-row flex-wrap text-center">
                    ...
                    {!! Form::select('field', $fields, '', ['class' => 'h-12 px-4 border-gray-300 rounded-md shadow-sm
                    focus:border-cyan-300 focus:ring focus:ring-cyan-200 focus:ring-opacity-50 w-full']) !!}
                </div>
                ...
                <div class="flex flex-row flex-wrap space-x-4 text-center">
                    ...
                    <div class="flex flex-row flex-wrap space-x-2 text-center">
                        <label class="radio-inline">{!! Form::radio('willingness', '1', false, ['class' =>
                            'border-gray-300
                            rounded-full bg-white text-mainCyanDark']) !!}有</label>
                        <label class="radio-inline">{!! Form::radio('willingness', '0', false, ['class' =>
                            'border-gray-300
                ...
                <div class="flex flex-row flex-wrap text-center">
                    ...
                    {!! Form::input('number', 'score_academic', null, ['class' => 'h-12 px-4 border-gray-300 rounded-md
                ...
                <div class="flex flex-row flex-wrap text-center">
                    ...
                    <div class="flex flex-row flex-wrap text-center">
                        <label class="radio-inline">{!! Form::radio('physical_pass', 1,false, ['class' =>
                            'border-gray-300
                            rounded-full bg-white text-mainCyanDark']) !!}合格</label>
                        <label class="radio-inline">{!! Form::radio('physical_pass', 0,false, ['class' =>
                            'border-gray-300
                ...
                <div class="flex flex-row flex-wrap text-center">
                    ...
                    <div class="flex flex-row flex-wrap text-center">
                        <label class="radio-inline">{!! Form::radio('pass', 1,false, ['class' => 'border-gray-300
                            rounded-full bg-white text-mainCyanDark']) !!}合格</label>
                        <label class="radio-inline">{!! Form::radio('pass', 0,false, ['class' => 'border-gray-300
                            rounded-full bg-white text-mainCyanDark']) !!}不合格</label>
                    </div>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="p-2 border-r last:border-r-0">{!! Form::checkbox('dp_subjects[]',
                                    $dpSubject->id,
                                    null, ['class' => 'border-gray-300 rounded-sm bg-white
                                    text-mainCyanDark'])
                                    !!}</td>
                            </tr>
                            @endforeach
