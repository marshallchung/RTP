...
<head>
    ...
    <style>
        ...
        .navbar-brand py-[0.3125rem] ml-4 text-xl whitespace-nowrap {
            padding: .75rem 1rem;
            font-size: 1rem;
        }
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="{{ route('log-viewer::dashboard') }}"
            class="navbar-brand py-[0.3125rem] ml-4 text-xl whitespace-nowrap mr-0">
