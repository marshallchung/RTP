...
<div x-data="{
    ...
    {!! Form::open(['method' => 'POST', 'route' => 'admin.dp-teachers.store', 'files' => true,'class'=>'flex flex-row
        ...
        <div class="relative w-full mb-6 bg-white border border-gray-200 rounded-sm">
            ...
            <div class="flex flex-col w-full p-5 m-0 space-y-6 bg-white">
                <div class="flex flex-row flex-wrap text-center">
                    ...
                    {!! Form::select('location', $counties, null, ['class' => 'h-12 px-4 border-gray-300 rounded-md
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="p-2 border-r last:border-r-0">{!!
                                    Form::select("dp_subjects[{$dpSubject->id}]",
                                    [null => '', '基本師資' => '基本師資', '種子師資'
                                    => '種子師資'], null, ['@change'=>'updatePassDateInput','class' => 'dp-subjects-selector
