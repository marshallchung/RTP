...
<div x-data="{
    ...
    destroyRoute:'{{ route('admin.plans.destroy-file',99999999) }}',
    ...
    <div class="flex flex-row flex-wrap w-full">
        ...
        {{-- <a href="{{ route('admin.plans.downloadXlsx', request()->all()) }}"
        ...
        <table class="w-full bg-white border shadow-lg text-mainAdminTextGrayDark">
            <thead>
                <tr class="border-b rounded-t bg-mainGray">
                    ...
                    <th class="p-2 font-normal text-left border-r last:border-r-0">執行計畫檔案</th>
                </tr>
            </thead>
                    ...
                    <tr class="border-b last:border-b-0 odd:bg-white even:bg-mainLight">
                        ...
                        <td class="p-2 border-r last:border-r-0">
                            <div class="flex flex-col items-start w-full space-y-2 justify-stretch">
                                <template x-if="countyUser.plans">
                                    <template x-for="(plan, plan_idx) in countyUser.plans"
