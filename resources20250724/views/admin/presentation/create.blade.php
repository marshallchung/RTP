...
[Auth::user()->name . "資料上傳", route('admin.presentation.create')],
]
])
...
<div x-data="{
    year:'{{ $year }}',
    changeYear(){
        location.href = '/admin/presentation/submit?year=' + this.year;
    },
}" x-init="$nextTick(() => {
    ...
    <div class="flex flex-col w-full max-w-3xl">
        <div class="relative mb-6 bg-white border border-gray-200 rounded-sm">
            ...
            <div class="p-5 m-0 bg-white">
                ...
                {!! Form::open(['method' => 'POST', 'route' => 'admin.presentation.store', 'files' => true]) !!}
                ...
                <div class="flex flex-col items-center justify-center py-16">
                    ...
                    .docx,
                    .jpg, .jpeg, .png, .gif, .zip, .rar, .txt, .csv, .xlsx, .odf, .mp4, .mov, .ppt, .pptx']) !!}
