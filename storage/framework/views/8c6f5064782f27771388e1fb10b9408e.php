    ...
    <div class="md:w-67/100 xl:w-75/100">
        ...
        'required'
                ...
                <div class="flex flex-row flex-wrap text-center">
                    ...
                    <?php echo Form::select('county_id', $counties, request('county_id'), [
        ...
        'class' => 'h-12 px-4 border-gray-300 rounded-md shadow-sm
                ...
                <div class="flex flex-row flex-wrap text-center">
                    ...
                    <?php echo Form::text('addressId', null, [
        'class' => 'h-12 px-4 border-gray-300 rounded-md shadow-sm
                    focus:border-cyan-300 focus:ring focus:ring-cyan-200 focus:ring-opacity-50 w-full'
    ]); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Marshall/Desktop/RTP-main/resources/views/admin/dp-training-institution/edit.blade.php ENDPATH**/ ?>