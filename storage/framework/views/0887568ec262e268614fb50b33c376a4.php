    ...
    <div class="flex flex-col items-center justify-start w-full max-w-[34rem] border rounded-3xl bg-white">
        ...
        <div class="relative flex items-start justify-start w-full p-8 text-mainAdminTextGrayDark">
            <form x-data="{
                ...
                iUsername:'',
                showPassword:false,
            }" method="POST" action="<?php echo e(route('admin.auth.auth')); ?>" accept-charset="UTF-8"
                ...
                <label class="relative flex flex-col items-start justify-start w-full space-y-2">
                    ...
                    <div class="relative flex flex-row w-full">
                        ...
                        <input x-ref="username" x-model="iUsername"
                            class="w-full h-12 pl-10 pr-4 placeholder-gray-400 <?php echo e($errors->has('username')?'border-rose-300 focus:border-rose-300 focus:ring-rose-200':'border-gray-300 focus:border-sky-300 focus:ring-sky-200'); ?> rounded-md shadow-sm focus:ring focus:ring-opacity-50"
                ...
                <div
                    ...
                    <?php echo e($errors->first('username')); ?></div>
                <?php endif; ?>
                <label class="relative flex flex-col items-start justify-start w-full mt-8 space-y-2">
                    ...
                    <div class="relative flex flex-row w-full">
                        ...
                        <input x-ref="password" x-model="iPassword" :type="showPassword?'text':'password'"
                            class="w-full h-12 px-10 placeholder-gray-400 <?php echo e($errors->has('password')?'border-rose-300 focus:border-rose-300 focus:ring-rose-200':'border-gray-300 focus:border-sky-300 focus:ring-sky-200'); ?> rounded-md shadow-sm focus:ring focus:ring-opacity-50"
                ...
                <div class="relative flex flex-row items-start justify-center w-full mt-8">
                    <div class="g-recaptcha" data-sitekey="<?php echo e(config('google-recaptcha.site-key')); ?>"></div>
                </div>
                <?php if($errors->has('g-recaptcha-response')): ?>
                <div
                    class="border help-block bg-rose-50 border-rose-100 w-full text-rose-400 py-1.5 rounded-sm relative mt-0.5 px-3 after:border-b-rose-50 after:border-b-[6px] after:absolute after:left-[17px] after:-top-[6px] after:border-l-[6px] after:border-r-[6px] after:border-l-transparent after:border-r-transparent before:border-b-rose-100 before:border-b-[7px] before:absolute before:left-4 before:-top-[7px] before:border-l-[6px] before:border-r-[6px] before:border-l-transparent before:border-r-transparent">
                    <?php echo e($errors->first('g-recaptcha-response')); ?></div>
                <?php endif; ?> 
                <button type="submit"
...
<?php echo $__env->make('admin.layouts.pixeladmin', ['bodyClass' => 'page-signin'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Marshall/Downloads/RTP-main/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>